...
class FlagSymbolRenderer extends SymbolRenderer {
  ...
  void paint(ChartCanvas canvas, Rectangle<num> bounds,
    ...
    final tl = Point(center.x - 1, center.y - 12);
    final tr1 = Point(center.x + 1, center.y - 12);
    final tr2 = Point(center.x + 5, center.y - 8);
    final tr3 = Point(center.x + 1, center.y - 6);
    final br = Point(center.x + 1, center.y);

    canvas.drawPolygon(points: [bl, tl, tr1, tr2, tr3, br], fill: Color(r: strokeColor.a, g: strokeColor.g, b: strokeColor.b, a: 255));
