...
class CustomLineRendererConfig<D> extends LayoutViewConfig
  ...
  @override
  CustomLineRenderer<D> build() {
    return new CustomLineRenderer<D>(config: this, rendererId: customRendererId);
  }
}
